...
for (let i=0; i < starWarsCharacters.length; i++){
  // console.log(starWarsCharacters[i].starWarsCharacters.name)
...
*/
const eyeColor = {
  blue:[] , yellow:[] , blue:[] ,brown: [] ,red:[] ,blue_gray:[]
}
...
if(crewMass > 1000){
  ...
  console.log("Ship is more half loaded")
}
else if(crewMass < 500){
...
for (let i=0; i < starWarsCharacters.length; i++){
  if((starWarsCharacters[i].gender === "n/a") || (starWarsCharacters[i].gender === "robot")){
    switchGender.push (starWarsCharacters[i].gender)
}
}
...
function printCharacterProperties(character) {
  console.log(`Ecco alcune informazioni su ${character.name}:`);
...
printCharacterProperties(randomCharacter);
